...
export function checkCard(answer: unknown, sourceText: string): { card: Card | null; problem: string } {
  ...
  // 6б. Төслийг батлагдсан мэт бичиж болохгүй (хууль хараахан батлагдаагүй)
  if (/боллоо|батлагдсан|батлагдлаа|чөлөөлөгдлөө|өөрчлөгдлөө/i.test(hook + " " + youMeaning)) {
    return { card: null, problem: 'төслийг батлагдсан мэт бичсэн ("боллоо" гэх мэт). "Төсөлд санал болгож байна" гэж бич' };
  }
...
ЭНЭ БОЛ ТӨСӨЛ:
- Энэ бол УИХ-д өргөн мэдүүлсэн ТӨСӨЛ, хараахан батлагдаагүй. "боллоо", "батлагдсан", "чөлөөлөгдлөө", "өөрчлөгдлөө" гэж бүү бич.
- "Төсөлд ... гэж санал болгож байна", "... болгохоор тусгажээ", "Батлагдвал ..." гэж бич.

ХЭНД ХАМААРАХ НӨХЦӨЛ:
- Хэнд хамаарах нөхцөлийг (иргэн бүр, хүүхэдтэй залуу гэр бүл, насны хязгаар гэх мэт) текстэд яг байгаагаар нь хэл.
- Нөхцөлийг бүү өргөтгө, бүү хая: "иргэн"-ийг "гэр бүл" гэж, "иргэний сонгосон нэг"-ийг "эхний нэг" гэж бүү бич.

ХЭЛ, ӨНГӨ АЯС:
- Энгийн, цэвэр монгол хэл. Зохиомол "залуучуудын хэллэг", англи үг бүү холь.
- Товчлол (БХ, ЗГ гэх мэт) бүү хэрэглэ, бүтэн үгээр бич.
- Уншигч 16-18 настай. Тамхи, архи худалдаж авах тухай түүнд шууд бүү ханд ("чи тамхи авахдаа" гэх мэт).
