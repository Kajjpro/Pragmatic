  ...
  return (
    <div className="flex flex-col gap-5">
      <nav className="flex items-center gap-2 text-[12px] text-ink-500">
        <Link href="/staff" className="hover:text-brand-700">
          Миний төслүүд
        </Link>
        <span>/</span>
        <span className="text-ink-950">Шинэ төсөл</span>
      </nav>

      <div>
        <h1 className="font-editorial text-2xl font-medium text-ink-950">
          Шинэ төсөл оруулах
        </h1>
